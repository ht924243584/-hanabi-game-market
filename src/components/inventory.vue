    ...
    <el-container class="is-vertical" :style="{backgroundImage: 'url(' +headerurl+ ')'} " >
      ...
      <div class="data public">
        <div class="mid_nav">
          <div class="nav">
            <ul>
              <li><a href="javascript:void(0)"  @click="clicknav(1,$event)">我的库存<i class="el-icon-caret-top" style="color: royalblue;"></i></a></li>
              <li><a href="javascript:void(0)"  @click="clicknav(2,$event)">购买记录<i class="el-icon-caret-top" style="color: royalblue;"></i></a></li>
              <li><a href="javascript:void(0)"  @click="clicknav(3,$event)">我的还价<i class="el-icon-caret-top" style="color: royalblue;"></i></a></li>
            </ul>
            <!-- <div class="nav_right">
              <span>
                件数:XX
	...
	item_val1(val,event,id,name){
	  ...
	  clicknav(index,event){
	    ...
	    if(index==1){
	      ...
	      this.$router.push({path:"/inventory/purchasehistory"});
	    }else{
	     this.selectPrice=true;
	     this.$router.push({path:"/inventory/Counteroffer"});
	    }
